									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a  class="text-muted">Awards and Nominees
</a>
											</li>
...
<div class="modal  " id="edit" tabindex="-1" role="dialog" aria-labelledby="addservice" aria-hidden="true">
  <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
   ...
   //    load_about();
        ...
        $("#box1").load("awards_and_nominees/load_gallery.php");     
        }
            
            
          function add_abt_gallery_img()  {
            
           if( fetch('awards_and_nominees/add_abt_gallery_img.php',{
                method:"POST",
    ...
    $.ajax({
            type: 'GET',
            data: {id:value},	
			url: 'awards_and_nominees/del_about_gallery.php',
        ...
        load_gallery();
          ...
          var value=id;
            ...
            type: 'GET',
            data: {id:value},	
			url: 'awards_and_nominees/edit_about_gallery.php',
			success: function(data){
