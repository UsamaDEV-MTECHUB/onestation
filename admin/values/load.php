...
while($row=mysqli_fetch_assoc($run)) {
    ...
    echo '
    <form class="card p-5 col-12  " id="updateaboutform"  action="values/update.php" method="GET" enctype="multipart/form-data">
    <h2 class=" p-4 mb-5 border-bottom">Update Values</h2>
    <div class="row">
   <div class="col-md-6">
   ...
   <div class="fv-plugins-message-container"></div>
    ...
    <input class="form-control h-auto py-4 rounded-lg " type="text" id="title" name="heading" value="'.$row['heading'].'" required="">
   <div class="fv-plugins-message-container"></div>
         </div>
        <div class="form-group ">
        <label class=" font-weight-bolder text-dark"> video_link</label>
        <input class="form-control h-auto py-4 rounded-lg " type="text" id="video_link" name="video_link" value="'.$row['video_link'].'" required="">
    <div class="fv-plugins-message-container"></div>
            </div>
         </div>
