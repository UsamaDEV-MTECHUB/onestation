...
if(isset($_POST['update'])) {
   ...
   echo  $newicon='images/award-logo/'.basename($_FILES["icon"]["name"]);
    if($_SESSION['pre_icon']==$newicon) {
        echo 'file are same ';
        header('location:../awards_and_nominees.php?action=done');
     }
    else {
        echo 'file are diff '; 
        ...
        $sql="UPDATE award  SET image='$dbpath' WHERE  id='$_POST[id]'";
