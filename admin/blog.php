...
<div class="modal  " id="edit" tabindex="-1" role="dialog" aria-labelledby="addservice" aria-hidden="true">
  <div class="modal-dialog modal-lg   modal-dialog-centered" role="document">
   ...
   load_about();
        ...
        function load_about()  {
        $("#servicearea").load("blog/load.php");     
        }
            

        function load_gallery()  {
        $("#box1").load("blog/load_gallery.php");     
        }
            
            
          function add_abt_gallery_img()  {
            
           if( fetch('blog/add_abt_gallery_img.php',{
                method:"POST",
    ...
    $.ajax({
            type: 'GET',
            data: {id:value},	
			url: 'blog/del_about_gallery.php',
        ...
        load_gallery();
          ...
          var value=id;
            ...
            type: 'GET',
            data: {id:value},	
			url: 'blog/edit_about_gallery.php',
			success: function(data){
