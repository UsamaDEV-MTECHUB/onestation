...
while($row=mysqli_fetch_assoc($run)) {
    ...
    echo '
    <form class="card p-5 col-12  " id="updateaboutform"  action="career/update.php" method="GET" enctype="multipart/form-data">
    <h2 class=" p-4 mb-5 border-bottom">Update Details</h2>
    <div class="row">   
   <div class="col-md-6">
...
<div class="row">
         ...
         <label class=" font-weight-bolder text-dark"> projects complete</label>
         <input class="form-control h-auto py-4 rounded-lg " type="text" id="projects_completed" name="projects_completed" value="'.$row['projects_completed'].'"  required="">
      <div class="fv-plugins-message-container"></div>
              </div>
