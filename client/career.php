    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="showAjaxResults">
       ...
       load_about();
        ...
        function load_about()  {
        $("#box").load("career/load.php");     
        }
            

        function load_career_post()  {
        $("#box1").load("career/load_career_post.php");     
        }
            
            
          function add__career_post()  {
            
           if( fetch('career/add__career_post.php',{
                method:"POST",
        ...
        function del_career_post(id)  {
          var value=id;
            if(confirm("Confimm delete id = "+value)) {
    $.ajax({
            type: 'GET',
            data: {id:value},	
			url: 'career/del_career_post.php',
        ...
        load_career_post();
          ...
          alert(value);
            ...
            type: 'GET',
            data: {id:value},	
			url: 'career/edit_career_post.php',
			success: function(data){
