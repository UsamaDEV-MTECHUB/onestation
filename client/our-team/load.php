...
while($row=mysqli_fetch_assoc($run)) {
    ...
    echo '
    <form class="card p-5 col-12  " id="updateaboutform"  action="our-team/update.php" method="GET" enctype="multipart/form-data">
   ...
   <div class="form-group ">
         <label class=" font-weight-bolder text-dark"> Projects completed</label>
