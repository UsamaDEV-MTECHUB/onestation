  ...
  <div class="modal-dialog modal  modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Hero</h5>
      ...
      <div class="modal-body" id="servicearea">
         ...
         <input class="form-control h-auto py-4 rounded-lg " type="text" id="name" name="name"  required="">
      ...
      <div class="fv-plugins-message-container"></div>
                                ...
                                <div class="form-group ">
         <label class=" font-weight-bolder text-dark"> Facebook link</label>
         <input class="form-control h-auto py-4 rounded-lg " type="text" id="fb" name="fb"  required="">
      <div class="fv-plugins-message-container"></div>
              </div> 
					
                                <div class="form-group ">
         <label class=" font-weight-bolder text-dark"> Twiter link</label>
         <input class="form-control h-auto py-4 rounded-lg " type="text" id="twitter" name="twitter"  required="">
      <div class="fv-plugins-message-container"></div>
              </div> 
					
                                <div class="form-group ">
         <label class=" font-weight-bolder text-dark"> Linkedin link</label>
         <input class="form-control h-auto py-4 rounded-lg " type="text" id="linkedin" name="linkedin"  required="">
      <div class="fv-plugins-message-container"></div>
              </div> 
...
<div class="modal  " id="edit" tabindex="-1" role="dialog" aria-labelledby="addservice" aria-hidden="true">
  <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="showAjaxResults">
       ...
       load_our_team();
        ...
        function load_our_team()  {
        $("#box").load("our-team/load.php");     
        }
            

        function load_gallery()  {
        $("#box1").load("our-team/load_gallery.php");     
        }
            
            
          function add_abt_gallery_img()  {
            
           if( fetch('our-team/add_abt_gallery_img.php',{
                method:"POST",
    ...
    $.ajax({
            type: 'GET',
            data: {id:value},	
			url: 'our-team/del_about_gallery.php',
        ...
        load_gallery();
          ...
          var value=id;
            ...
            type: 'GET',
            data: {id:value},	
			url: 'our-team/edit_about_gallery.php',
			success: function(data){
