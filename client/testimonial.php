									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a  class="text-muted">Testimonial
</a>
											</li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="servicearea">
                ...
                <label>Testimonial</label>
									<input class="form-control h-auto py-4 rounded-lg " type="text" id="Description" name="Description" required>
								<div class="fv-plugins-message-container"></div>
                                </div>
...
<div class="modal  " id="edit" tabindex="-1" role="dialog" aria-labelledby="addservice" aria-hidden="true">
  <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
   ...
   //    load_about();
        ...
        $("#box1").load("testimonial/load_gallery.php");     
        }
            
            
          function add_abt_gallery_img()  {
            
           if( fetch('testimonial/add_abt_gallery_img.php',{
                method:"POST",
    ...
    $.ajax({
            type: 'GET',
            data: {id:value},	
			url: 'testimonial/del_about_gallery.php',
        ...
        load_gallery();
          ...
          var value=id;
            ...
            type: 'GET',
            data: {id:value},	
			url: 'testimonial/edit_about_gallery.php',
			success: function(data){
