						...
						<div class="subheader py-6 py-lg-8 " >
                            ...
                            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a  class="text-muted">Blog category</a>
											</li>
                                ...
                                <div class="card-toolbar">
											...
											<i class="fas fa-plus fa-1x"></i>Add Blog Category </a>
											<!--end::Button-->
										</div>
							</div>
						</div>
...
<div class="modal fade" id="showservice" tabindex="-1" role="dialog" aria-labelledby="addservice" aria-hidden="true">
  <div class="modal-dialog  modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      </div>  <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_login_singin_form" novalidate="novalidate" action="javascript:void(0);" >
      <div class="modal-body" id="servicearea">
								...
								<div class="form-group ">
									...
									<input class="form-control h-auto py-4 rounded-lg " type="text" id="title" name="name" required>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="showAjaxResults">
       ...
       // load_service();
        ...
        $("#box").load("blog_category/load.php");     
        }
            
            
          function adds()  {
            
           if( fetch('blog_category/add.php',{
                method:"POST",
