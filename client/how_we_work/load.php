...
$sql="SELECT * FROM how_we_work";
$run=mysqli_query($conn,$sql);
while($row=mysqli_fetch_assoc($run)) {
       
    echo '
    <form class="card p-5 col-12  " id="updateaboutform"  action="how_we_work/update.php" method="GET" enctype="multipart/form-data">
    <h2 class=" p-4 mb-5 border-bottom">Update Section</h2>
    <div class="row">
   <div class="col-md-6">
