                 ...
                 <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                         ...
                         <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                             ...
                             <div class="card-toolbar">
                                 ...
                                 <?php
                                            ...
                                            echo 'Update process for <span class="badge badge-success">'.$row_ser['title'].'</span> ';
                     ...
                     <div class="d-flex flex-column-fluid">
                         ...
                         <div class="container table-responsive" id="box">
                             <form class="insert-form" id="insert_form" method="POST" action="services_process/update.php" enctype="multipart/form-data">
                                ...
                                $sqll="SELECT * FROM process WHERE s_id='$_GET[s_id]'"; 
                                  ...
                                  ?>
                                         ...
                                         <td><input type="text" class="form-control " name="title[]" value="<?php echo $rowl['title'];?>" /> </td>
                                         <td>

                                             <div class="row text-center bg-primary" style="height:200px;overflow-y:scroll;">
                       ...
                       if($rowl['icon_id']==$row['id']) {
                       echo ' <input type="checkbox" name="icon[]"  value="'.$row['id'].'" onclick="this.value='.$row['id'].';" checked/>';
                           
                       }                  
                                         
                   else {
                       echo ' <input type="checkbox" name="icon[]"  value="'.$row['id'].'" onclick="this.value='.$row['id'].';" />';
                   }
                 echo'    <span class="mr-2"></span>
                    <img src="../'.$row['image'].' " class=""  width="50px" />
                                    ...
                                    ?></div>
                                         ...
                                         <td><textarea class="form-control description" rows="10" name="description[]"><?php echo $rowl['description'];?></textarea></td>
...
function decre() {
    del--; 
         ...
         function update() {
              ...
              setTimeout(function() { 
              if (fetch('services_process/update.php', {
                     method: "POST",
