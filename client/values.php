  ...
  <div class="modal-dialog  modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Vision layout</h5>
...
<div class="modal  " id="edit" tabindex="-1" role="dialog" aria-labelledby="addservice" aria-hidden="true">
  <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="showAjaxResults">
       ...
       load_about();
        ...
        function load_about()  {
        $("#box").load("values/load.php");     
        }
            

        function load_gallery()  {
        $("#box1").load("values/load_gallery.php");     
        }
            
            
          function add_abt_gallery_img()  {
            
           if( fetch('values/add_abt_gallery_img.php',{
                method:"POST",
    ...
    $.ajax({
            type: 'GET',
            data: {id:value},	
			url: 'values/del_about_gallery.php',
        ...
        load_gallery();
          ...
          var value=id;
            ...
            type: 'GET',
            data: {id:value},	
			url: 'values/edit_about_gallery.php',
			success: function(data){
